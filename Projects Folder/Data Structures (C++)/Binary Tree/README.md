...
## Midterms Analysis
After running the program 5 times, `printMemoryUsage()` shows an average of 3471.2 peak RAM usage. In addition, the program was run 5 times on [Jdoodle](https://www.jdoodle.com/online-compiler-c++) and was compiled and executed in an average of 2.048 seconds. Lastly, the worst time complexity of the program is O(n).
